...
| project_decision_agent | 019ec02f-ac76-7863-899a-3af5498ce444 | active | 3 | Phase 3.15 runtime authorization plan 方向预审 | APPROVED，符合只读授权计划层方向，可进入 GitHub 免费版；商业代码仍不得进入 GitHub 免费版 push | 仅在阶段、收费边界、发布方向、商业边界或重大取舍时复用 |
