...
| network_safety_agent | 019ec02f-ad02-7ae0-8c00-c7baeb46709e | active | 7 | Phase 3.3-A Boot Metadata Proxy 产品承诺网络安全收口 | APPROVED；未发现生产 LAN、DHCP 接管、ProxyDHCP/TFTP runtime、UDP 67/69/4011、TP-Link/OpenWrt、路由/网关/防火墙/DNS、host network 或 privileged 风险 | 触及 Compose 网络、端口、DHCP、ProxyDHCP、TFTP、路由或网关时必须复用 |
| architecture_agent | 019ec02f-adf7-7162-8721-3b127ac3e51f | active | 4 | Phase 3.3-A Boot Metadata Proxy 产品承诺与只读边界 | APPROVED，允许文档、只读 API、只读 UI、只读预检；运行时 ProxyDHCP/TFTP、UDP 67/69/4011、生产 LAN 测试和网络设备变更继续 BLOCKED | 改 API、数据模型、阶段边界或受控 PXE 集成结构时复用 |
