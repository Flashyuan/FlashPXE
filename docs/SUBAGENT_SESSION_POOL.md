...
| project_decision_agent | 019ec02f-ac76-7863-899a-3af5498ce444 | active | 2 | 免费版提交 push 前方向确认 | APPROVED，允许将本轮免费版提交推送到当前 GitHub 分支；商业代码仍不得进入 GitHub 免费版 push | 仅在阶段、收费边界、发布方向、商业边界或重大取舍时复用 |
